...
<div class="right_side_wrapper--wide">
	<div class="page-text-wrapper">
      ...
      <table class="table table-bordered yajra-datatable text-center" id="tbl_schedule">
        <thead>
          <tr>
            <th>ID</th>
        ...
        <tbody>
          @foreach ($time_ranges as $time_range)
            <tr>
              ...
              <td class="py-0">
                <div class="row">
                  <select class="form-control col-md-3 ml-2" name="from_hour" id="from_hour">
                  ...
                  <p class="col-md-1 text-center"><b>:</b></p>
                  
                  <select class="form-control col-md-3" name="from_min" id="from_min">
                    <option value="-1"></option>
                    @for($i=0; $i<60; $i++)
                      @if ($i < 10)
                  ...
                  <select class="form-control col-md-3" name="from_sec" id="from_sec">
                    <option value="-1"></option>
                    @for($i=0; $i<60; $i++)
                      @if ($i < 10)
              ...
              <td class="py-0">
                <div class="row">
                  <select class="form-control col-md-3 ml-2" name="to_hour" id="to_hour">
                    <option value="-1"></option>
                    @for($i=0; $i<24; $i++)
                      @if ($i < 10)
                  ...
                  <select class="form-control col-md-3" name="to_min" id="to_min">
                    <option value="-1"></option>
                    @for($i=0; $i<60; $i++)
                      @if ($i < 10)
                  ...
                  <select class="form-control col-md-3" name="to_sec" id="to_sec">
                    <option value="-1"></option>
                    @for($i=0; $i<60; $i++)
                      @if ($i < 10)
